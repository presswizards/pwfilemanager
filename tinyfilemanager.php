...
//Application Title
define('APP_TITLE', 'Press Wizards File Manager');
...
$auth_users = array(
    'presswizardsadmin' => '$2y$10$rQKqgAMUI96Q30S0Qhledeotz42aG2sVer2VlOdK96mFIZjcvIW6i',
    'pwreadonly' => '$2y$10$Fg6Dz8oH9fPoZ2jJan5tZuv6Z4Kp7avtQ9bDfrdRntXtPeiMAZyGO'
);
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://github.com/presswizards/pwfilemanager" target="_blank" class="app-v-title"> Press Wizards File Manager <?php echo VERSION; ?></a></h3></p>
                        <p>Original Author: Prasath Mani</p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://github.com/presswizards/pwfilemanager" target="_blank" class="float-right text-muted">PW File Manager <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://github.com/presswizards/pwfilemanager" target="_blank" class="float-right text-muted">PW File Manager <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Press Wizards File Manager';      $tr['en']['AppTitle']           = 'PW File Manager';
